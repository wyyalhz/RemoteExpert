...
public:
    ...
    // 打包控制命令
    static QByteArray packControlCommand(MsgType1 commandType, uint32_t roomId, const QJsonObject& extraData = QJsonObject());

    // 打包通用消息
    static QByteArray packMessage(MsgType1 type,
